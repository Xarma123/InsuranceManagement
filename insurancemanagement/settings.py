...
ALLOWED_HOSTS = ['fathomless-caverns-67165.herokuapp.com']
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'aryan.sharma.cd.cse20@itbhu.ac.in'
EMAIL_HOST_PASSWORD = 'LuxmiVihar@123'
EMAIL_RECEIVING_USER = ['bhushan645@gmail.com']
